...
type SwitchVariants = VariantProps<typeof SwitchPrimitiveRoot>;
type SwitchRootPrimitiveProps = React.ComponentProps<typeof SwitchPrimitive.Root>;
type SwitchProps = SwitchRootPrimitiveProps & SwitchVariants;

export const Switch = forwardRef<React.ElementRef<typeof SwitchPrimitiveRoot>, SwitchProps>((props, ref) => (
  <SwitchPrimitiveRoot {...props} ref={ref}>
